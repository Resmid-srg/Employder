...
class ChatViewController: MessagesViewController {
    ...
    private func configureInputBarItems() {
        ...
        messageInputBar.sendButton.image = UIImage(systemName: "paperplane.fill")?.maskWithColor(color: .purpleMainColor())
...
extension ChatViewController: MessagesDisplayDelegate {
    ...
    func backgroundColor(for message: MessageType, at indexPath: IndexPath, in messagesCollectionView: MessagesCollectionView) -> UIColor {
        isFromCurrentSender(message: message) ? .purpleMainColor().withAlphaComponent(0.8) : .purpleLightColor().withAlphaComponent(0.05)
    }
    ...
    func configureAvatarView(_ avatarView: AvatarView, for message: MessageType, at indexPath: IndexPath, in messagesCollectionView: MessagesCollectionView) {
        ...
        isFromCurrentSender(message: message) ? (avatarString = currentUser.avatarStringURL) : (avatarString = chat.friendUserImageStringURL)
...
extension ChatViewController: InputBarAccessoryViewDelegate {
    ...
    func inputBar(_: InputBarAccessoryView, didPressSendButtonWith text: String) {
        ...
        FirestoreService.shared.sendMessage(chat: chat, message: message, completion: { result in
            switch result {
            case .success():
...
struct ChatVCProvider: PreviewProvider {
    ...
    struct ContainerView: UIViewControllerRepresentable {
        ...
        let chatVC = ChatViewController(currentUser: MUser(userName: "1", avatarStringURL: "1", description: "1", email: "1", id: "1", sex: "1"), chat: MChat(friendUserName: "2", friendUserImageStringURL: "2", lastMessageContent: "2", friendId: "2"))
